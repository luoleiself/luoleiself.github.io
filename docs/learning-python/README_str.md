...
- 字符串解构赋值给变量, 未匹配到变量的剩余值保存为一个列表, 剩余值变量优先级最低
...
- find(sub[, start[, end]]) 和 index(sub[, start[, end]]) 查找子串出现的下标, find 未找到返回 -1, index 未找到报错
- rfind(sub[, start[, end]]) 和 rindex(sub[, start[, end]]) 逆向查找子串出现的下标, rfind 未找到返回 -1, rindex 未找到报错
...
- center()|ljust()|rjust() 对齐字符串, 在指定的空间范围内对齐, 如果空间范围小于字符串长度则返回原值
...
- split() 分割字符串, 返回不包含分隔符的列表
- rsplit() 反向分割字符串, 和 split() 类似
- partition() 分割字符串, 返回元组
    - 返回一个包含分隔符之前、分隔符、分隔符之后的部分的3元组
    - 如果未匹配到分隔符, 则返回一个包含字符串本身、两个空字符串的3元组
- rpartition() 反向分割字符串, 和 partition() 类似
...
- removeprefix() 移除字符串的指定前缀, 移除成功返回新字符串, 移除失败返回原字符串
- removesuffix() 移除字符串的指定后缀, 移除成功返回新字符串, 移除失败返回原字符串
...
salary = 5000
tel = 13112345678
print("my salary is %.2f, my tel is %d" % (salary, tel))  # 数据项使用元组形式        
...
```python
print('The {1} is in the {0}'.format('lake', 'woodchuck'))
...
```python
print('The {thing} is in the {place}'.format(place='lake', thing='woodchuck'))
'The woodchuck is in the lake'
```
...
```python
print('The {:10s} is at the {:10s}'.format('wraith', 'window'))
...
# 进制转换
# 在对齐字符之前为填充字符
print('x = {:#^10b}'.format(10))
'x = ###1010###'
print('x = {:#^10o}'.format(10))
'x = ####12####'
print('x = {:#^10x}'.format(10))
'x = ####a#####'
# 对齐字符控制填充字符
print('x = {:^#010x}'.format(10))
'x = 0000xa0000'
# 对齐字符之前的填充字符
print('x = {:9^#014b}'.format(10))
'x = 99990b10109999'
# 没有对齐字符的填充字符
print('x = {:#014b}'.format(10))
'x = 0b000000001010'

# 显示进制前缀
print('x = {:10b}'.format(100))
'x =    1100100'
print('x = {:#10b}'.format(100))  # 显示二进制带前缀 0b
'x =  0b1100100'
print('x = {:+#10b}'.format(100))
'x = +0b1100100'
print('x = {:#10o}'.format(100))  # 显示八进制带前缀 0o
'x =      0o144'
print('x = {:#10x}'.format(100))  # 显示十六进制带前缀 0x
'x =       0x64'
```
...
print(one_third)
Fraction(1, 3)
print(f'{one_third!s} is {one_third!r}')  # !s 输出字符串, !r 输出 repr()
'1/3 is Fraction(1, 3)'

string = "¡kočka 😸!"
print(f'{string!a}')  # 输出字符串的 ascii 编码
"'\\xa1ko\\u010dka \\U0001f638!'"
```
...
print(f'{x = :^+10b}')
'x =  +1100100 '
print(f'{x = :^+#10b}')  # 居中显示二进制带符号带前缀 0b
'x = +0b1100100'
print(f'{x = :^+#10o}')  # 居中显示八进制带符号带前缀 0o
'x =   +0o144  '
