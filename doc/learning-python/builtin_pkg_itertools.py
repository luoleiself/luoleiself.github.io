...
print(f'operator.add(1, 10) = {operator.add(1, 10)}')
print(f'operator.sub(10, 1) = {operator.sub(10, 1)}')
print(f'operator.lt(1, 10) = {operator.lt(1, 10)}')

print(f'operator.is_not(1, 2) = {operator.is_not(1, 2)}')
print(f'operator.contains([1, 2], 1) = {operator.contains([1, 2], 1)}')

print(f'operator.lshift(5, 1) = {operator.lshift(5, 1)}')
print(f'operator.rshift(5, 1) = {operator.rshift(5, 1)}')

print(
    f'operator.concat([1, 2, 3], ["a", "b"]) = {operator.concat([1, 2, 3], ["a", "b"])}')

print(f'operator.and(True, False) = {operator.and_(True, False)}')
