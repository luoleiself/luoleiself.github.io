...
[wepback](https://webpack.docschina.org/) 是目前前端构建生产环境应用程序的热门工具, 它采用基于事件流的机制, 将各个插件串联起来完成相关的功能, [compiler](https://webpack.docschina.org/api/compiler-hooks/) 模块是 [wepback](https://webpack.docschina.org/) 的主要引擎, 它扩展(extend)自 [Tapable](https://github.com/webpack/tapable#tapable) 类, 用来注册和调用插件.
